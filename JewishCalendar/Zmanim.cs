...
namespace JewishCalendar
{
    ...
    public class Zmanim
    {
        ...
        {
            HourMinute[] netzShkia = this.GetNetzShkia(false);
        ...
        public static ArrayList GetHolidays(IJewishDate jDate, bool inIsrael)
        {
            ...
            {
                list.Add(new SpecialDay("Erev Shabbos", "ערב שבת", SpecialDay.SpecialDayTypes.Information | SpecialDay.SpecialDayTypes.HasCandleLighting));
            }
            ...
            switch (jMonth)
            {
                ...
                case 3: //Sivan
                    ...
                    else if (jDay == 6) list.Add((inIsrael ?
                ...
                case 4: //Tamuz
                    ...
                    break;
                case 5: //Av
                    if (jDay == 9 && dayOfWeek != DayOfWeek.Saturday) list.Add(
                        new SpecialDay("Tisha B'Av", "תשעה באב", SpecialDay.SpecialDayTypes.FastDay));
                    else if (jDay == 10 && dayOfWeek == DayOfWeek.Sunday) list.Add(
                        new SpecialDay("Tisha B'Av", "תשעה באב", SpecialDay.SpecialDayTypes.FastDay));
                    else if (jDay == 15) list.Add(
                ...
                case 7: //Tishrei
                    ...
                    else if (jDay.In(17, 18, 19, 20)) list.Add(
                        new SpecialDay("Sukkos - Chol HaMoed", "סוכות - חול המועד", SpecialDay.SpecialDayTypes.MinorYomtov));
                    else if (jDay == 21) list.Add(
                ...
                case 13:
                    ...
                    {
                        if (jDay == 11 && dayOfWeek == DayOfWeek.Thursday) list.Add(
                            new SpecialDay("Fast - Taanis Esther", "תענית אסתר", SpecialDay.SpecialDayTypes.FastDay));
                        else if (jDay == 13 && dayOfWeek != DayOfWeek.Saturday) list.Add(
                            new SpecialDay("Fast - Taanis Esther", "תענית אסתר", SpecialDay.SpecialDayTypes.FastDay));
                        if (jDay == 14) list.Add(

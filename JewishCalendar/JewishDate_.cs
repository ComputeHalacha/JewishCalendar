...
namespace JewishCalendar
{
    ...
    /// </remarks>
    [Serializable]
    public class JewishDate_ : IJewishDate
    {
        ...
        /// </summary>
        public JewishDate_() : this(System.DateTime.Now) { }
        ...
        public JewishDate_(Location location) : this(System.DateTime.Now, location) { }
        ...
        public JewishDate_(int year, int month, int day)
        {
            //If the year is less than the min supported date for Hebrew Calendar
            if (year <= MIN_HC_YEAR)
            {                
                this.GregorianDate = new JewishDate(year, month, day).GregorianDate;
            }
            else
            {
        ...
        public JewishDate_(int year, int month, int day, TimeSpan timeOfDay)
        {
            if (year <= MIN_HC_YEAR)
            {                
                this.GregorianDate = new JewishDate(year, month, day).GregorianDate;
        ...
        public JewishDate_(System.DateTime dateTime)
        {
        ...
        /// <param name="location">The location. This will be used to determine the time of sunset.</param>
        public JewishDate_(System.DateTime date, Location location)
            : this(date)
        {
            if (location != null)
            {
        ...
        /// </summary>
        public static JewishDate_ MaxDate
        {
            get
            {
                return new JewishDate_(Utils.HebrewCalendar.MaxSupportedDateTime);
            }
        }
        ...
        /// </summary>
        public static JewishDate_ MinDate
        {
            get
            {
                return new JewishDate_(DateTime.MinValue);
            }
        }
        ...
        public DateTime GregorianDate
        {
            ...
            set
            {
                ...
                {
                    var jdm = new JewishDate(this._gregorianDate);
                    this._year = jdm.Year;
        ...
        public IJewishDate AddMonths(int months)
        {
            ...
            return new JewishDate_(year, month, day, this.GregorianDate.TimeOfDay);
        }
        ...
        public int GetDayOfOmer()
        {
            ...
            {
                dayOfOmer = (this - new JewishDate_(this.Year, 1, 15));
            }
            return dayOfOmer;
        }
        ...
        /// </summary>
        /// <param name="jd"></param>
        public static explicit operator JewishDate_(JewishDate jd)
        {
            return new JewishDate_(jd.Year, jd.Month, jd.Day);
        }
        ...
        /// <returns></returns>
        public static JewishDate_ operator -(JewishDate_ hd, int days)
        {
            return new JewishDate_(hd.GregorianDate.AddDays(-days));
        }
        ...
        /// <returns></returns>
        public static int operator -(JewishDate_ hd, JewishDate_ hd2)
        {
        ...
        /// <param name="jd2"></param>
        /// <returns></returns>
        public static bool operator !=(JewishDate_ jd1, IJewishDate jd2)
        {
            return !(jd1 == jd2);
        }

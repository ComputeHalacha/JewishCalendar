...
class JewishDate:
    ...
    def daysJMonth(year, month):
        if ((month == 2) or (month == 4) or (month == 6) or ((month == 8) and
            ...
            (not JewishDate.isJdLeapY(year))) or (month == 13)):
                return 29
        else:
            return 30
    ...
    def getHolidays(self, israel, hebrew):
        ...
        if (jDay == 30):
            ...
            list.append("ראש חודש " + Utils.jMonthsHeb[monthIndex]) if hebrew else "Rosh Chodesh " + Utils.jMonthsEng[monthIndex] 
        elif (jDay == 1 and jMonth != 7):
            list.append("ראש חודש " + Utils.jMonthsHeb[jMonth] if hebrew else "Rosh Chodesh " + Utils.jMonthsEng[jMonth])
        ...
        if (dayOfWeek != 6 and (not israel) and secDate.month == 12):
            ...
            if (sday in [5, 6, 7]):
                ...
                if ((((sday == 5 or (sday == 6 and dayOfWeek == 0)) and (not nextYearIsLeap))) or ((sday == 6 or (sday == 7 and dayOfWeek == 0)) and nextYearIsLeap)):
            ...
            if jMonth ==1: # Nissan
                if (jDay == 12 and dayOfWeek == 4):
                    ...
                    list.append(("פסח - חול המועד" if hebrew else 'Pesach  - Chol HaMoed') if israel else ("פסח - יום שני" if hebrew else "Pesach - Second Day"))
                ...
                elif (jDay == 6): ('חג השבועות' if hebrew else 'Shavuos') if israel else ('שבועות - יום ראשון' if hebrew else 'Shavuos - First Day')

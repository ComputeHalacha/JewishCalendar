...
namespace Luach
{
    public partial class frmMonthlyHebrew : Form
    {
        ...
        private StringFormat _tooltipStringFormat = new StringFormat
        {
            LineAlignment = StringAlignment.Center,
            FormatFlags = StringFormatFlags.DirectionRightToLeft | StringFormatFlags.FitBlackBox | StringFormatFlags.LineLimit
        };
        #endregion
        ...
        public frmMonthlyHebrew()
        {
            ...
            this._dayHeadersFont = new Font(this.pnlMain.Font.FontFamily, 12, FontStyle.Regular);
            ...
            this._tooltipFont = this._dayHeadersFont;
        }
        #endregion
        ...
        private void frmMonthlyHebrew_Load(object sender, EventArgs e)
        {
            ...
            if (_currentJewishDate == null)
                this.CurrentJewishDate = new JewishCalendar.JewishDate(this._currentLocation);
        ...
        private void toolTip1_Popup(object sender, PopupEventArgs e)
        {
            if (e.AssociatedControl == this.pnlMain)
            {
                var size = TextRenderer.MeasureText(
                    toolTip1.GetToolTip(e.AssociatedControl), this._tooltipFont);
                size.Width += 40;
                size.Height += 40;
                e.ToolTipSize = size;
            }
        ...
        private void pnlMain_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            if (tuple != null)
            {
                var f = new frmDailyHebrew { CurrentJewishDate = tuple.Item1, Owner = this };
                f.Show(this);
            }
        }
        ...
        {
            this.CurrentJewishDate = new JewishDate(this.CurrentJewishDate.Year - 1, this.CurrentJewishDate.Month, this.CurrentJewishDate.Day);
        }
        ...
        private void pnlMain_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (tuple != null && this._selectedDay != tuple.Item1)
            {
